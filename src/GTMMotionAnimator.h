...
@interface GTMMotionAnimator : NSObject <GTMCoreAnimationTraceable>
 ...
 */
- (void)animateWithTraits:(nonnull GTMAnimationTraits *)traits
                  between:(nonnull NSArray *)values
                    layer:(nonnull CALayer *)layer
                  keyPath:(nonnull GTMAnimatableKeyPath)keyPath;
...
@interface GTMMotionAnimator (UIKitEquivalency)
...
/**
 ...
 supports. See GTMAnimatableKeyPaths for a full list of implicilty animatable
 CALayer properties.
 */
...
/**
 ...
 API supports. See GTMAnimatableKeyPaths for a full list of implicilty
...
@interface GTMMotionAnimator (Legacy)
...
@interface GTMMotionAnimator (ImplicitLayerAnimations)
...
/**
 ...
 be able to implicitly animate its properties with GTMMotionAnimator. This is not necessary for
