...
// bi-directional animation using the GTMMotionAnimator object. GTMMotionAnimator is designed for
// building fine-tuned explicit animations. Unlike UIView's implicit animation API, which can be
// used to cause cascading animations on a variety of properties, GTMMotionAnimator will always add
...
- (void)didTap {
  ...
  [animator animateWithTraits:traits.chipHeight
                      between:@[ @([self chipCornerRadius]), @0 ]
                        layer:_chipView.layer
                      keyPath:GTMKeyPathCornerRadius];
